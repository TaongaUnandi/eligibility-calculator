...
const interest = prompt("Please enter the interest");
const serviceFee = prompt("Please enter the service fee");
...
function eligibilityCalculator(rate, nper, pmt) {
  ...
  const amountDisbursed = maxLoanAmount * (1 - serviceFee / 100);
